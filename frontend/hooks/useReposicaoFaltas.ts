...
export function useReposicaoFaltas(
  ...
  useEffect(() => {
    ...
    async function carregar() {
      ...
      // linhas 'concluido'.
      // tipo_falta 'unidade_fechada' fica de fora: feriado, ponto facultativo e falta de
      ...
      const r1Faltas     = (r1.data ?? []).filter((r: any) => r.status === 'falta' && !r.falta_revertida_em && r.tipo_falta !== 'unidade_fechada')
