...
-- supabase/migrations/20260922220000_substituicao_nos_leitores.sql
--
-- Rodar INTEIRO. As quatro funcoes sao independentes entre si, mas todas
-- dependem do tipo 'substituicao', criado por 20260922210000 (ja aplicada).
--
-- ATENCAO: recria get_auditoria_assim_periodo, que e a funcao central da
-- Conferencia ASSIM. O corpo e o de 20260916130100 com UMA linha alterada
-- (o LATERAL `vin`). Se algo der errado, reaplicar 20260916130100 restaura.
--
-- DEPOIS DE APLICAR, conferir:
--   1. /auditoria-assim?tab=auditoria -- "Falta Terapeuta" deve DIMINUIR em 1
--      no dia 21/09 (a sessao do Joao Lucas passa a contar como realizada);
--   2. a guia 81418 (paciente 12488, 03/09) deve VOLTAR a aparecer como orfa
--      na Reconciliacao, agora com botao de vinculo.
--
-- Query de conferencia do item 2:
--   SELECT * FROM public.get_guias_orfas('2026-09-03','2026-09-03')
--   WHERE guia = '81418';
